                    ...
                    <div className="mt-12 text-slate-700 text-lg leading-relaxed grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <form className="space-y-6">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-medium text-slate-900">Nome</label>
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-sm font-medium text-slate-900">Mande Sua Mensagem</label>
                                ...
                                <button type="submit" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-slate-700 hover:bg-gradient-to-r hover:text-white hover:to-violet-400 hover:via-orange-400 hover:via-cyan-500 hover:from-red-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                    Enviar Mensagem
                                </button>
                            </form>
                        </div>
