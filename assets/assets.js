...
export const categories = ["Alimentos e Bebidas", "Automotivo", "Celulares e Comunicação", "Computadores e Informatica", "Casa, Jardim, Limpeza", "Vestuario"];
...
export const ourSpecsData = [
    { title: "Frete Grátis", description: "Aproveite a entrega rápida e gratuita em todos os pedidos, sem condições, apenas entrega confiável na porta.", icon: SendIcon, accent: '#05DF72' },
    { title: "7 Dias de Devolução Fácil", description: "Mudou de ideia? Sem problemas. Devolva qualquer item dentro de 7 dias.", icon: ClockFadingIcon, accent: '#FF8904' },
